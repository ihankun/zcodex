...
export const desktopMenuMessageIds = {
  ...
  helpDownloadUpdateManually: "desktopMenu.help.downloadUpdateManually",
  helpOpenDownloadedInstaller: "desktopMenu.help.openDownloadedInstaller",
...
export const desktopMenuMessages: Record<Locale, DesktopMenuLocaleMessages> = {
  "zh-CN": {
    ...
    "desktopMenu.help.downloadUpdateManually": "下载新版本（{version}）",
    "desktopMenu.help.openDownloadedInstaller": "打开安装包（{version}）",
